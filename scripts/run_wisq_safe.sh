...
#   - Limits BQSKit workers to a fraction of available CPU cores
...
#   BQSKIT_NUM_WORKERS     - Number of BQSKit workers (default: half of CPU cores)
...
#
# Examples:
#   # Run with defaults (50% cores, nice 15, idle I/O)
#   ./scripts/run_wisq_safe.sh uv run wisq circuit.qasm -ap 1e-10 -ot 300
#
...
calculate_workers() {
    ...
    fraction="${BQSKIT_WORKER_FRACTION:-0.5}"
